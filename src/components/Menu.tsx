...
const Menu: React.FC = () => {
	...
	return (
		<div className="relative inline-block text-left" ref={menuRef}>
			...
			<HamburgerMenuIcon
				onClick={toggleMenu}
				className="w-11.25 h-11.25 p-2.5 rounded-full bg-[#DD5D18] text-white cursor-pointer max-[433px]:w-[10vw] max-[433px]:h-[10vw] min-[433px]:hidden"
			/>
			{isOpen && (
				<div className="absolute z-50 right-0 mt-11 flex flex-col gap-3">
					<div className="bg-white/90 backdrop-blur-lg hover:bg-white rounded-2xl shadow-lg w-79 py-9 px-7">
						<Root>
					...
					<div className="bg-[#171717CC] backdrop-blur-lg hover:bg-[#171717] rounded-2xl shadow-lg w-79 py-9 px-7">
						<div className="flex flex-col gap-4">
							...
							<input
								...
								className="w-60 text-white border-0 border-b border-white/27 focus:outline-none focus:border-white mx-2.5 py-4 placeholder-white-400"
							/>
							<button
								type="button"
								className="w-25 h-11.25 border-2 border-[#DD5D18] bg-[#DD5D18] hover:bg-[#8D58FF] mx-2.5 py-2 px-4.5 text-lg text-white rounded-4xl cursor-pointer"
								onClick={() => {
