...
function KnowMoreComponent({
	...
	return (
		<div className="my-5 mx-auto max-w-380.25 relative max-[1553px]:mx-4 max-[1553px]:mb-4">
			<button
				type="button"
...
function ExpandedKnowMoreComponent({
	...
	return (
		<div className="my-5 mx-auto max-w-380.25 relative max-[1553px]:mb-4 max-[1553px]:mx-4">
			<div className="bg-white p-2.5 border border-white rounded-2xl flex flex-row flex-wrap-reverse justify-between items-stretch max-[900px]:gap-4">
				<div className="flex flex-col flex-1/2 shrink-0 p-16 max-[900px]:px-0 max-[900px]:py-4">
					...
					<button
						type="button"
						className="mt-6.5 w-50.5 border-2 border-[#DD5D18] bg-[#DD5D18] hover:bg-[#8D58FF] text-white text-lg font-normal py-2.5 px-5 rounded-full my-2 cursor-pointer max-[1440px]:text-[16px]"
						onClick={() => {
				...
				<div className="flex flex-col flex-1/2 min-w-83.25 shrink-0 relative max-[400px]:min-w-65">
					{!isMobile && (
						<button
							type="button"
...
function KnowMore() {
	...
	return (
		<div id="aboutme" className="scroll-mt-30">
			...
			<div className="py-1.5 my-27 mx-40 flex flex-row justify-between items-center max-[1440px]:my-24 max-[1300px]:mx-4">
			...
			<div className="max-w-380.25 h-0.5 bg-black/17 my-7 mx-auto max-[1553px]:mx-4"></div>
		</div>
	);
}
