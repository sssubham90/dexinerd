...
function Footer() {
	return (
		<div className="bg-white pt-29 pb-13.5">
			<div className="flex flex-col bg-white mx-auto max-w-380.25 max-[1553px]:mx-4">
				<div className="flex flex-row flex-wrap justify-between max-[768px]:flex-col max-[768px]:items-start">
					<div className="flex flex-col flex-7 min-[406px]:min-w-101.5">
						<img
							src={HeadingLogo}
							alt="Dexinerd"
							className="w-88.75 max-[1440px]:w-75 max-[400px]:w-full"
						/>
						<p className="text-lg text-[#2F2F2F] font-medium leading-[191%] mt-17 mb-12.5 max-w-172 max-[1440px]:text-[16px]">
							With Dexinerd, design isn't just a craft - it's a journey of
							creativity, purpose, and meaningful connections
						</p>
						<p className="text-lg text-[#2F2F2F] font-medium leading-[191%] mb-12.5 max-[1440px]:text-[16px]">
							Bengaluru, Karnataka, India
						</p>
					</div>
					<div className="flex flex-row flex-3 min-w-70 gap-36 max-[1521px]:gap-20 max-[1024px]:gap-15 justify-center">
						<div className="flex flex-col">
							<h3 className="text-2xl text-[#DD5D18] font-medium leading-[191%]">
								Navigation
							</h3>
							<div className="flex flex-col gap-2 mt-12.5 text-lg text-[#2F2F2F] font-medium leading-[191%] max-[1440px]:text-[16px]">
								<button
									type="button"
				...
				<div className="w-380 max-[1520px]:w-[calc(100vw-32px)] h-0.5 bg-black/17 my-12 mx-auto"></div>
